...
import im.zego.zimkitgroup.databinding.ActivityGroupManagerBinding;
import im.zego.zimkitgroup.viewmodel.ZIMKitGroupManagerVM;

public class ZIMKitGroupManagerActivity extends BaseActivity<ActivityGroupManagerBinding, ZIMKitGroupManagerVM> {
    private String mId;
    ...
    public void copy(View view) {
        ...
        ToastUtils.showToast(this,getString(R.string.group_copy_success));
    }
